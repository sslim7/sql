...
select * from jobs_log WHERE source REGEXP
        "'subs_orders_id': '(
e14d7756-408c-49df-8a89-612a73743504|
uuid2|
uuid3|
uuid4)'"
         order by created_at desc;

select * from subs_order_cancel where subs_orders_id='e14d7756-408c-49df-8a89-612a73743504';
...
#                                          and so.subs_orders_id='e14d7756-408c-49df-8a89-612a73743504'
             ...
             WHERE jl.result NOT LIKE '%status_code=200%'
